...
const ContactPage = () => {
  useSEO({
    ...
    description: "Get in touch with Care Home Recovery. We're here to help you take the first step towards a better life.",
  });
  ...
  return (
    <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      CARE HOME<br />
                      Panchpota Dhalai Bridge<br />
                      Gomkol Stopage, Garia Station Road<br />
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:6289424181" className="text-primary hover:underline">6289424181</a>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-healthcare-light-blue flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    ...
                    <a href="mailto:saibalsanyal2@gmail.com" className="text-primary hover:underline">saibalsanyal2@gmail.com</a>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 bg-section-alt">
        <div className="container mx-auto px-4">
          <FadeIn direction="up" className="rounded-2xl overflow-hidden shadow-xl">
            <iframe
